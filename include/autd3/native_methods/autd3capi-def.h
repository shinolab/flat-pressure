...
AUTD3_API [[nodiscard]] uint8_t AUTDEmitIntensityWithCorrectionAlpha(uint8_t value, double alpha);

AUTD3_API [[nodiscard]] uint8_t AUTDPhaseFromRad(double value);

AUTD3_API [[nodiscard]] double AUTDPhaseToRad(uint8_t value);

AUTD3_API [[nodiscard]] LoopBehavior AUTDLoopBehaviorInfinite();

AUTD3_API [[nodiscard]] LoopBehavior AUTDLoopBehaviorFinite(uint32_t v);

AUTD3_API [[nodiscard]] LoopBehavior AUTDLoopBehaviorOnce();

AUTD3_API void AUTDGetErr(void* src, char *dst);

AUTD3_API [[nodiscard]] ResultSamplingConfig AUTDSamplingConfigFromFrequencyDivision(uint32_t div);

AUTD3_API [[nodiscard]] ResultSamplingConfig AUTDSamplingConfigFromFrequency(double f);

AUTD3_API [[nodiscard]] ResultSamplingConfig AUTDSamplingConfigFromPeriod(uint64_t p);

AUTD3_API [[nodiscard]] uint32_t AUTDSamplingConfigFrequencyDivision(SamplingConfiguration config);

AUTD3_API [[nodiscard]] double AUTDSamplingConfigFrequency(SamplingConfiguration config);

AUTD3_API [[nodiscard]] uint64_t AUTDSamplingConfigPeriod(SamplingConfiguration config);
