...
class SamplingConfiguration final {
 public:
  ...
  auto operator<=>(const SamplingConfiguration& other) const { return _internal.div <=> other._internal.div; }  // LCOV_EXCL_LINE
  bool operator==(const SamplingConfiguration& other) const { return _internal.div == other._internal.div; }    // LCOV_EXCL_LINE
